...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 60.0, 30.0, 25.0 ],
					"text" : "g"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 255.0, 15.0, 210.0, 35.0 ],
					"text" : "comb filter for reverberation networks\n(with fixed 1 sample delay)"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 15.0, 15.0, 185.0, 25.0 ],
					"text" : "y[n] = x[n-1] + g*y[n-1]"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 120.0, 210.0, 77.0, 20.0 ],
					"text" : "send~ #0_fb"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 120.0, 90.0, 90.0, 20.0 ],
					"text" : "receive~ #0_fb"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 249.5, 177.0, 108.0, 177.0, 108.0, 177.0, 98.0, 177.0 ],
					"source" : [ "obj-7", 0 ]
				}
