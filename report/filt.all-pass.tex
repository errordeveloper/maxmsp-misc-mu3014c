...
\begin{figure} \begin{pspicture}[showgrid=true](-5,0)(5,6)
 ...
 \pscircleop        (-2.5,3.5)    {sum0}
 \dotnode           (-1.5,3.5)    {dot0}

 \psfblock          (0,3.5)  {del}   {$Z^{-m}$}

 \pscircleop        (2.5,3.5)     {sum1}
 \dotnode           (1.5,3.5)     {dot1}
 ...
 \ncangle[angleA=-180]{->}{dot0}{g1d}
 \ncangle[angleA=-180,angleB=160]{->}{g0d}{sum0}
 \ncangle[angleB=-30]{->}{g1d}{sum1}
